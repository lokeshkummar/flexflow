        ...
        <>
            <div className='min-h-screen w-full text-white'>
                <div className='relative z-10 w-full'>
                    <h1 className='uppercase pt-20 md:pt-10 scale-y-150 md:text-[200px] text-[75px] md:-mt-5  font-extrabold text-center text-neutral-300'>FlexFlow</h1>
                </div>
                <div className='h-full w-full absolute z-20 flex justify-center top-24 '>
                    <div className='absolute flex flex-col gap-5 md:left-32 left-5 bottom-14 my-7 md:bottom-32'>
