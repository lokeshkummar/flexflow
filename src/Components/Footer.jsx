...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className='text-2xl font-mono flex flex-col md:flex-row md:justify-between justify-center text-white/90 font-semibold  my-5 mx-5 md:mx-32'>
        <h3>+91-7668589458</h3>
        <h3>contact@flexflow.com</h3>
        <h3>Manali, Himachal Pradesh India.</h3>
      </div>
